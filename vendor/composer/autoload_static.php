...
class ComposerStaticInit649adad2cfd458bf7c39b17587712cef
{
    ...
    public static $classMap = array (
        'AIP_Admin' => __DIR__ . '/../..' . '/includes/class-aip-admin.php',
        'AIP_Claude' => __DIR__ . '/../..' . '/includes/class-aip-claude.php',
        'AIP_Database' => __DIR__ . '/../..' . '/includes/class-aip-database.php',
        'AIP_Frontend' => __DIR__ . '/../..' . '/includes/class-aip-frontend.php',
        'AIP_Membership' => __DIR__ . '/../..' . '/includes/class-aip-membership.php',
        'AIP_PDF' => __DIR__ . '/../..' . '/includes/class-aip-pdf.php',
        'AIP_REST_API' => __DIR__ . '/../..' . '/includes/class-aip-rest-api.php',
        'AIP_Skyscanner' => __DIR__ . '/../..' . '/includes/class-aip-skyscanner.php',
        'AIP_Travelpayouts' => __DIR__ . '/../..' . '/includes/class-aip-travelpayouts.php',
        'AIP_Updater' => __DIR__ . '/../..' . '/includes/class-aip-updater.php',
        'AIP_WooCommerce' => __DIR__ . '/../..' . '/includes/class-aip-woocommerce.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit649adad2cfd458bf7c39b17587712cef::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit649adad2cfd458bf7c39b17587712cef::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInit649adad2cfd458bf7c39b17587712cef::$classMap;
