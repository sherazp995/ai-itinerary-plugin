...
return array(
    ...
    'AIP_Claude' => $baseDir . '/includes/class-aip-claude.php',
    'AIP_Database' => $baseDir . '/includes/class-aip-database.php',
    'AIP_Frontend' => $baseDir . '/includes/class-aip-frontend.php',
    'AIP_Membership' => $baseDir . '/includes/class-aip-membership.php',
    'AIP_PDF' => $baseDir . '/includes/class-aip-pdf.php',
    'AIP_REST_API' => $baseDir . '/includes/class-aip-rest-api.php',
    'AIP_Skyscanner' => $baseDir . '/includes/class-aip-skyscanner.php',
    'AIP_Travelpayouts' => $baseDir . '/includes/class-aip-travelpayouts.php',
    'AIP_Updater' => $baseDir . '/includes/class-aip-updater.php',
    'AIP_WooCommerce' => $baseDir . '/includes/class-aip-woocommerce.php',
